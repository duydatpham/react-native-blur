...
public class RealtimeBlurView extends View {
	...
	private float mBlurRadius = 10;//dp (0 < r <= 25)
...
//		mBlurRadius = 15;//a.getDimension(R.styleable.RealtimeBlurView_realtimeBlurRadius,
////				TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
//		mDownsampleFactor = 8;//a.getFloat(R.styleable.RealtimeBlurView_realtimeDownsampleFactor, 4);
//		mOverlayColor = 0xAAFFFFFF;//a.getColor(R.styleable.RealtimeBlurView_realtimeOverlayColor, 0xAAFFFFFF);
////		a.recycle();
